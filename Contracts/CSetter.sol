...
contract CSetter is PoolToken, CStorage {
    ...
    function _initialize(
        ...
        require(msg.sender == factory, "Gremlin: UNAUTHORIZED"); // sufficient check
        _setName(_name, _symbol);
        underlying = _underlying;
        borrowable0 = _borrowable0;
        borrowable1 = _borrowable1;
        gremlinPriceOracle = IFactory(factory).gremlinPriceOracle();
    }
    ...
    function _checkSetting(
        ...
        _checkAdmin();
        require(parameter >= min, "Gremlin: INVALID_SETTING");
        require(parameter <= max, "Gremlin: INVALID_SETTING");
    }

    function _checkAdmin() internal view {
        require(msg.sender == IFactory(factory).admin(), "Gremlin: UNAUTHORIZED");
    }
}
